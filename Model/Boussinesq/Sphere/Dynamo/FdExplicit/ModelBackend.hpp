...
#ifndef QUICC_MODEL_BOUSSINESQ_SPHERE_DYNAMO_FDEXPLICIT_MODELBACKEND_HPP
#define QUICC_MODEL_BOUSSINESQ_SPHERE_DYNAMO_FDEXPLICIT_MODELBACKEND_HPP
...
protected:
   ...
   /**
    * @brief Get radial finite differences grid
    */
   const Internal::Array& getGrid(const int size) const;
...
private:
    ...
    */
   mutable std::shared_ptr<Internal::Array> mpGrid;
};
...
#endif // QUICC_MODEL_BOUSSINESQ_SPHERE_DYNAMO_FDEXPLICIT_MODELBACKEND_HPP

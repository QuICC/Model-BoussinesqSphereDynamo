...
#ifndef QUICC_MODEL_BOUSSINESQ_SPHERE_DYNAMO_EXPONENTIAL_PHYSICALMODEL_HPP
#define QUICC_MODEL_BOUSSINESQ_SPHERE_DYNAMO_EXPONENTIAL_PHYSICALMODEL_HPP
...
{
   TBuilder::init();
#ifdef QUICC_MODEL_BOUSSINESQSPHEREDYNAMO_EXPONENTIAL_BACKEND_CPP

   this->mpBackend = std::make_shared<ModelBackend>();
#else
   throw std::logic_error("Python model is not implemented");
#endif
}
...
#endif // QUICC_MODEL_BOUSSINESQ_SPHERE_DYNAMO_EXPONENTIAL_PHYSICALMODEL_HPP

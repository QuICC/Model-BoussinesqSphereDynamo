/**
 * @file MomentumKernelICBL.hpp
 * @brief Physical kernel for the Momentum nonlinear kernel
 */

#ifndef QUICC_PHYSICAL_MOMENTUMKERNELICBL_HPP
#define QUICC_PHYSICAL_MOMENTUMKERNELICBL_HPP
...
namespace Kernel {
    ...
    * @brief Physical kernel for the Momentum nonlinear kernel
    */
   class MomentumKernelICBL: public IPhysicalKernel
   {
      public:
         /**
          * @brief Simple constructor
          */
         explicit MomentumKernelICBL();

         /**
          * @brief Simple empty destructor
          */
         virtual ~MomentumKernelICBL();
   ...
   /// Typedef for a smart MomentumKernelICBL
   typedef std::shared_ptr<MomentumKernelICBL> SharedMomentumKernelICBL;

}
}
}

#endif // QUICC_PHYSICAL_MOMENTUMKERNELICBL_HPP
